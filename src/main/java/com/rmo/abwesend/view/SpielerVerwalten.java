...
public class SpielerVerwalten extends BasePane implements PropertyChangeListener {
	...
	private void addButtons(JPanel panel) {
		panel.add(btnLoeschen = new JButton("Spieler löschen"), getConstraintEingabe(0, 4));
		panel.add(btnSpeichern = new JButton("Daten speichern"), getConstraintEingabe(1, 5));
		panel.add(btnNeu = new JButton("Neue Spieler"), getConstraintEingabe(0, 5));
	...
	private JComponent addTableauList() {
		...
		mTableauList = new ArrayList<JCheckBox>();
		int col = 0;
		int row = 1;
	...
	private void readAllTableauData() {
		try {
			...
			mTableauListData = new ArrayList<Tableau>(); // statt remove
	...
	private void spielerTableauSpeichern() {
		...
		List<Integer> tableauListNew = new ArrayList<Integer>();	
