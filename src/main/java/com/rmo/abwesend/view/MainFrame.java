...
import com.rmo.abwesend.view.util.SpielerEinlesen;
...
//				setPaneLeft(mSpielerSelect.getPanel());
		...
		menuSpielerTableau.setToolTipText("Tableau eines Spielers selektieren, \nNeue Spieler aufnehmen, Name des Spielers ändern, Spieler löschen");
...
//				setPaneLeft(mSpielerSelect.getPanel());
		...
		JMenuItem menuSpielerEinlesen = new JMenuItem("Spieler einlesen");
		menuSpielerEinlesen.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				SpielerEinlesen spielerEinlesen = new SpielerEinlesen();
