...
public class Spieler {
	 ...
	 */
	public Spieler() {
		abwesendList = new ArrayList<String>(Config.turnierMaxTage);
		tableauList = new ArrayList<Tableau>(5);
...
//	}
	...
	private void initSpieleList() {
		spieleList = new ArrayList<String>(Config.turnierMaxTage);
		for (int i = 0; i < Config.turnierMaxTage; i++) {
			spieleList.add(i, "");
		}
	}
	...
	private List<String> makeList(String list) {
		List<String> newList = new ArrayList<String>(Config.turnierMaxTage);
