...
public class Config {
	...
	public static final SimpleDateFormat sdfTagName = new SimpleDateFormat("EEE, dd.MM.yyyy HH:mm");
	public static final long einTag = 24*60*60*1000;	// für Datum in long
...
//	public static String dbPassword = "Tennis4123";
	...
	public static String webDriverFile = "C:/Program Files (x86)/Google/Chrome/Application/chromedriver.exe";
	...
	// Turnier Datum, in DB
	public static GregorianCalendar beginDatumTmp = new GregorianCalendar(2018, 8, 1); // 0=Jan
	...
	public static final String spielerListDirKey = "spieler.dir";
	public static final String spielerListFileKey = "spieler.file";
	public static final String spielerSplitCharKey = "spieler.splitChar";
//	public static final String spielerSplitChar = ";";
	public static final String emailListFileKey = "email.file";

	public static final String spielplanDirKey = "spielplan.dir";
	public static final String spielplanFileKey = "spielplan.file";
	public static final String spielplanTrennCharKey = "spielplan.trennCharDoppel";
	...
	public static void setAllValues() throws Exception {
		...
		// max Tage berechnen
		turnierMaxTage = Math.toIntExact((turnierEndDatum.getTime() - turnierBeginDatum.getTime()) / einTag) +1;
...
//	}
	...
	public static void readProperties() throws Exception {
		...
		if (mProperties.getProperty(dbNnameKey) == null) {
			mProperties.setProperty(dbNnameKey, dbNname);
		}
		else {
			dbNname = mProperties.getProperty(dbNnameKey);
		}
		...
		if (mProperties.getProperty(spielerListDirKey) == null) {
			mProperties.setProperty(spielerListDirKey, "C:/...");
		}
		if (mProperties.getProperty(spielerListFileKey) == null) {
			mProperties.setProperty(spielerListFileKey, "XX.txt");
		}
		if (mProperties.getProperty(spielerSplitCharKey) == null) {
			mProperties.setProperty(spielerSplitCharKey, ";");
		}
		if (mProperties.getProperty(emailListFileKey) == null) {
			mProperties.setProperty(emailListFileKey, "XX.txt");
		}
		if (mProperties.getProperty(spielplanDirKey) == null) {
			mProperties.setProperty(spielplanDirKey, "C:/Download");
		}
		if (mProperties.getProperty(spielplanFileKey) == null) {
			mProperties.setProperty(spielplanFileKey, "Calendar.xls");
		}
		if (mProperties.getProperty(spielplanTrennCharKey) == null) {
			mProperties.setProperty(spielplanTrennCharKey, "/");
		}
	...
	/**
	 * Die Werte von den Config Vars in die Property Liste schreiben
	 */
